		...
		<div class="container" id='pair' style="visibility: hidden">
			...
			<div id="timelineSection">
				...
				<form action = "<?php $_PHP_SELF ?>" method = "POST">
					<button id = "complete" name="complete" style="margin-right:1px; margin-bottom: 25px; float: right; margin-top: 20px;" type="submit" onclick="window.location.href = './compelete.html'" >Complete</button>
				</form> 
			</div>
			<br><br><br> 
			<div id="footer"></div>
